...
import os
import time
from typing import Any, Union, Tuple, Callable, Mapping
...
LossFn = Callable[[tf.Tensor, tf.Tensor, Union[tf.Tensor, None]],
                  Tuple[tf.Tensor, tf.Tensor, tf.Tensor, Union[tf.Tensor, None]]]
